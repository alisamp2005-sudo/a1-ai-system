...
КОНТЕКСТ КОМПАНИИ:
А1 — строительная компания, 16 активных объектов.
Названия объектов: Дом юстиции (Великий Новгород), ГАЗСТРОЙПРОМ (Минск), ЩЛЗ Лифты, ЩЛЗ Стройка, Алые паруса, ДРОЗ, ЖК ЛДМ (СПБ), Кубинка, Ленская 15, Мосводосток (Дмитровское шоссе), Остров-8, ППК ВСК (Ульяновск/Поливно), ППК ВСК (Чебаркуль), Хранилища, Реновация (Михалковская), ул.Житная (ФБУ РФЦСЭ).
